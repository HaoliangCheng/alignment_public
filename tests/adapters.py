...
# Import helper functions from the alignment modules
...
from cs336_alignment.helper_rl import (
...
def run_compute_group_normalized_rewards(
    ...
    # Return all three values as expected by the tests
...
def run_get_response_log_probs(
    ...
    # Return the full dictionary as expected by the tests
    return result
...
# # Import additional functions for the optional RLHF part
# try:
#     # These imports might not exist if the optional modules aren't implemented
#     from cs336_alignment.data_utils import get_packed_sft_dataset, iterate_batches
...
#         raise NotImplementedError("Optional RLHF modules not implemented")
